...
The three checks mirror workshop/hub_detection_no_threshold.ipynb,
workshop/community_structure_invisible.ipynb, and
workshop/merchant_overlap_volume_inflation.ipynb:
