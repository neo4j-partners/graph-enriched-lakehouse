"""Log, register, and deploy the simple finance agent."""
...
def main() -> None:
    ...
    model_name = setting("UC_MODEL_NAME", "simple-finance-agent")
    uc_model_name = f"{catalog}.{schema}.{model_name}"
    endpoint_name = setting(
        "MODEL_SERVING_ENDPOINT_NAME", "simple-finance-agent"
    )
    ...
    mlflow.set_experiment(f"{workspace_dir}/simple-finance-agent")
    ...
    with mlflow.start_run():
        logged_agent_info = mlflow.pyfunc.log_model(
            ...
            python_model="simple_finance_agent.py",
            resources=resources,
    ...
    deployment = agents.deploy(
        ...
        tags={
            "endpointSource": "simple-finance-agent",
